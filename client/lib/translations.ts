export const translations = {
  english: {
    ...
    locationActive: "Location services active",
    ...
    caregiverDescription: "View health updates and manage care settings",
    accessDashboard: "Access Dashboard",
    reminderSettings: "Reminder Settings",
    reminderDescription: "Customize your medication and appointment alerts",
    manageReminders: "Manage Reminders",
    appSettings: "App Settings",
    appSettingsDescription: "Adjust text size, language, and preferences",
    ...
    sampleText: "Sample text at selected size",
    darkMode: "Dark Mode",
    ...
    medicationRemindersDesc: "Get notified when it's time for medications",
    appointmentReminders: "Appointment Reminders",
    appointmentRemindersDesc: "Get notified about upcoming appointments",
    emergencyAlerts: "Emergency Alerts",
    emergencyAlertsDesc: "Important emergency notifications",
    soundAlerts: "Sound Alerts",
    soundAlertsDesc: "Play sound for notifications",
    vibration: "Vibration",
    vibrationDesc: "Vibrate for important alerts",
    emergencyContacts: "Emergency Contacts",
    emergencyContactsDesc: "Manage who gets notified in case of an emergency",
    ...
    missedThisWeek: "Missed This Week",
  ...
  spanish: {
    ...
    locationActive: "Servicios de ubicación activos",
    ...
    appSettingsDescription: "Ajustar tamaño de texto, idioma y preferencias",
    ...
    sampleText: "Texto de muestra al tamaño seleccionado",
    darkMode: "Modo Oscuro",
    darkModeDescription: "Más fácil para los ojos en poca luz",
    ...
    emergencyAlertsDesc: "Notificaciones importantes de emergencia",
    soundAlerts: "Alertas de Sonido",
    soundAlertsDesc: "Reproducir sonido para notificaciones",
    vibration: "Vibración",
  ...
  french: {
    ...
    locationActive: "Services de localisation actifs",
    ...
    sampleText: "Texte d'exemple à la taille sélectionnée",
    darkMode: "Mode Sombre",
    darkModeDescription: "Plus facile pour les yeux en faible luminosité",
    ...
    soundAlertsDesc: "Jouer un son pour les notifications",
    vibration: "Vibration",
